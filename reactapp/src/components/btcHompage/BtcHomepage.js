...
import BelowAppBar from './BelowAppBar';
...
const useStyles = makeStyles((theme) => ({
  ...
  bellowAppBar: {
    ...
    backgroundImage:
      "linear-gradient(to right, rgba(255,0,0,0), rgba(41,63,80,1))",
  },
  Plans: {
    backgroundImage:
        ...
        <Paper square>
          ...
          <Grid container>
              ...
              >
                <Toolbar>
                  <Grid container alignItems="center">
                    <Grid item justify="center" xs={3} outline="false">
                      <svg
            ...
            <Grid item container alignItems="center" direction="column">
              <Grid item xs={12} className={classes.bellowAppBar}>
                <Grid item xs={5}>
                  <paper square>
                    <BelowAppBar />
                  </paper>
              ...
              <Grid item xs={10} className={classes.Plans}>
              <Plans />
              </Grid>
              <Grid item>
                <Button>testmonies</Button>
              </Grid>
              <Grid item xs={12}>
                <LatestDeposits />
              </Grid>
